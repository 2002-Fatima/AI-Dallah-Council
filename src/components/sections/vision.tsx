        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          <FadeIn direction="right">
            <SectionHeader
              ...
              description="نؤمن بأن المطاعم تستحق منصة تفهم سوقها — لغة عربية، امتثال ZATCA، مدفوعات MADA، وموسمية الخليج. مجلس الدلّة يبني هذا المستقبل."
              align="start"
              className="mb-0"
            />
            ...
            >
              {[
                ...
                "امتثال ZATCA ومدفوعات MADA مدمجة",
                "أتمتة العمليات — الذكاء الاصطناعي يعمل خلف الكواليس",
              ].map((point) => (
                <motion.li
                  key={point}
                  variants={{
